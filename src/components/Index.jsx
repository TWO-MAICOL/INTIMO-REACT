   ...
   {/* <!-- End Header --> */}
    ...
    <section id="details" className="details">
      <div className="container">
        ...
        <div className="row content">
          <div className="col-md-4" data-aos="fade-right">
            <img src="../img/web/details-3.png" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row content">
          <div className="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="../img/web/details-4.png" className="img-fluid" alt=""/>
          </div>
          <div className="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
      ...
      <div className="container">
        ...
        <div className="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="testimonial-item">
                <img src="../img/web/testimonials/testimonials-2.jpg" className="testimonial-img" alt=""/>
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <p>
                  <i className="bx bxs-quote-alt-left quote-icon-left"></i>
